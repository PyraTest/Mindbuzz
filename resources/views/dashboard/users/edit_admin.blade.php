                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{route('admin.users.update_admin' , ['id'=> $user -> id])}}" method="post"
                                                        ...
                                                        @foreach($x as $model_name => $maps)
                                                            @foreach ($maps as $map)
                                                                ...
                                                                <label><input type="checkbox" name="permissions[]"
                                                                    value="{{$model_name.'_'.$data[$map]}}" {{ $user->hasPermission($model.'_'.$data[$map]) ? 'checked' : '' }}> @lang("user.$data[$map]")</label>
