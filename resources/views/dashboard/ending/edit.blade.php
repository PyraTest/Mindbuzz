                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.update_ending', $endings->id) }}"
                                            method="post">
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> تعديل النهاية </h4>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="program_id" class="form-control" id="">
                                                                ...
                                                                @foreach ($programs as $program)
                                                                    <option
                                                                        value="{{ $program->id }}"{{ $endings->program_id == $program->id ? 'selected' : '' }}>
                                                                        {{ $program->name }}
                                                                    </option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="test_id" id="" class="form-control">
                                                                ...
                                                                @foreach ($tests as $test)
                                                                    <option
                                                                        value="{{ $test->id }}"{{ $endings->test_id == $test->id ? 'selected' : '' }}>
                                                                        @if ($test->type == 0)
                                                                            Test
                                                                        @elseif ($test->type == 1)
                                                                            Quiz
