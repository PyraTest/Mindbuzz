                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.add_test') }}" method="post"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="type" id="type" class="form-control"
                                                                required>
                                                                <option value="{{ \App\Models\Test::TYPE_TEST }}">Test
                                                                </option>
                                                                <option value="{{ \App\Models\Test::TYPE_QUIZ }}">Quiz
                                                                </option>
                                                                <option value="{{ \App\Models\Test::TYPE_HOMEWORK }}">
                                                                    Homework</option>
                                                            </select>
                                                            @error('type')
                                                                <span class="text-danger">{{ $message }}</span>
