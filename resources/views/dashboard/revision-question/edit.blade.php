                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            action="{{ route('admin.update_revision_question', $revisionQuestions->id) }}"
                                            method="post" >
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> تعديل سؤال المراجعة </h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="number" class="form-control"
                                                                required value="{{ $revisionQuestions->number }}">
                                                            @error('number')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="question" class="form-control"
                                                                required value="{{ $revisionQuestions->question }}">
                                                            @error('question')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="answer" class="form-control"
                                                                required value="{{ $revisionQuestions->answer }}">
                                                            @error('answer')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
