                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0 " style="/*background-color: #F4F5FA;*/">
                        <div class="card-title text-center">
                            <div class="p-1 ">
                                <img src="{{asset('assets/website/images/app_icon.png')}}" class="img-fluid" style= "width :500px; height: 190px" alt="LOGO"/>
                            </div>
                        </div>
                            ...
                            <form class="form-horizontal form-simple" action="{{ route('admin.doLogin')}}" method="post"
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-0">
                                    <input type="text" name="username" class="form-control form-control-lg input-lg"
                                           value="" id="username" placeholder="أدخل البريد الالكتروني ">
