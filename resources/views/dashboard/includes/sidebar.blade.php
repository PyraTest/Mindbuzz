       ...
       <div class="main-menu-content">
              <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item  <?php if($active_links[0] == 'users')  echo 'open'; ?> "><a href="">
                     ...
                     <span class="menu-title"
                             data-i18n="nav.dash.main">{{__('admin.programs')}}</span>
             ...
             <ul class="menu-content">
                     ...
                     <li class="<?php if($active_links[1] === 'addcities') echo 'active'; ?>"><a
                                                 class="menu-item" href="{{route('admin.create_program')}}"
                    ...
                    <li class="nav-item  <?php if($active_links[0] == 'users')  echo 'open'; ?> "><a href="">
                     <i class="la la-group"></i>
                     <span class="menu-title"
                             data-i18n="nav.dash.main">{{__('admin.schools')}}</span>
                     <span class="badge badge badge-success badge-pill float-right mr-2">Placeholder
                     </span>
             </a>
             <ul class="menu-content">
                    ...
                    <li class="nav-item  <?php if($active_links[0] == 'users')  echo 'open'; ?> "><a href="">
                     <i class="la la-group"></i>
                     <span class="menu-title"
                             data-i18n="nav.dash.main">{{__('admin.stages')}}</span>
                     <span class="badge badge badge-success badge-pill float-right mr-2">Placeholder
                     </span>
             </a>
             <ul class="menu-content">
                     <li class="<?php if($active_links[1] === 'showusers') echo 'active'; ?> "><a
                                     class="menu-item" href="{{route('admin.stages')}}"
                                     data-i18n="nav.dash.ecommerce"> {{__('admin.show_all')}} </a>
                     </li>

                     <li class="<?php if($active_links[1] === 'addcities') echo 'active'; ?>"><a
                                                 class="menu-item" href="{{route('admin.create_stage')}}"
                                                 data-i18n="nav.dash.crypto">{{__('admin.add_school')}}</a>
                                   </li>
                    ...
                    <li class="nav-item  <?php if($active_links[0] == 'users')  echo 'open'; ?> "><a href="">
                     <i class="la la-group"></i>
                     <span class="menu-title"
                             data-i18n="nav.dash.main">{{__('admin.courses')}}</span>
                     <span class="badge badge badge-success badge-pill float-right mr-2">Placeholder
                     </span>
             </a>
             <ul class="menu-content">
                     <li class="<?php if($active_links[1] === 'showusers') echo 'active'; ?> "><a
                                     class="menu-item" href="{{route('admin.courses')}}"
                                     data-i18n="nav.dash.ecommerce"> {{__('admin.show_all')}} </a>
                     </li>

                     <li class="<?php if($active_links[1] === 'addcities') echo 'active'; ?>"><a
                                                 class="menu-item" href="{{route('admin.create_course')}}"
                                                 data-i18n="nav.dash.crypto">{{__('admin.add_school')}}</a>
                                   </li>
