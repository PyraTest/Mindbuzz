                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span>
                                <!--{{__('admin.hi')}}-->
                                <span  style="padding-top: 8px;" class="user-name text-bold-700"> Admin</span>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="/dashboard/logout"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-lang nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span>
                                <span style="padding-top: 8px;" class="user-name text-bold-700">{{App::getLocale()}}<i class="la la-language"></i></span>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-divider dropdown-divider-lang"></div>
                            @endforeach
                        </div>
                    </li>
                    ...
                    {{--  <li class="dropdown dropdown-notification nav-item">  --}}
                        {{--  <a class="nav-link " href="{{route('admin.notifications.index')}}" ><i class="ficon ft-bell"></i>  --}}
                        {{--  <a class="nav-link " href="" ><i class="ficon ft-bell"></i>  --}}
                            {{--  <span  --}}
                                {{--  class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{ App\Models\Order::count() }}</span>  --}}
                                {{--  class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{ App\Models\Order::where('seen' , 0)->count() }}</span>  --}}
                        {{--  </a>  --}}
...
<script>
    lines = document.querySelectorAll('.dropdown-divider-lang')
