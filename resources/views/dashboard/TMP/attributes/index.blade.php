                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.markets')}}">{{ __('admin/sidebar.markets') }}</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('admin.markets.edit',$market -> id)}}">{{$market->name}}</a>
                                </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form action="{{ route('admin.attributes' , ['market_id'=> $market_id]) }}" method="get">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" style="padding-right: 0px !important;">
                                                    ...
                                                    <a class="btn btn-outline-primary  btn-min-width box-shadow-3"
                                                        href="{{ route('admin.attributes.create' , ['market_id'=> $market_id]) }}">
                                                        {{__('admin/forms.add')}}
                                                    </a>
                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a href="{{route('admin.attributes.edit', ['market_id'=> $market_id , 'id'=> $attr -> id])}}"
                                                                   class="btn btn-info box-shadow-3 mr-1 "><i class="ft-edit"></i></a>

                                                                <a href="{{route('admin.attributes.delete', ['market_id'=> $market_id , 'id'=> $attr -> id])}}"
