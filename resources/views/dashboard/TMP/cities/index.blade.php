<?php
$active_links = ['cities' , 'showcities'];
?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">{{__('admin/sidebar.cities')}}</h3>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($cities as $city)
                                                    <tr>
                                                        <td class="text-info">{{$city->name}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a href="{{route('admin.cities.delete', ['id'=> $city -> id])}}"
