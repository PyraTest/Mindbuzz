                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($numbers as $index => $number)
                                                <tr>
                                                    ...
                                                    <td class="text-info">{{translateUser($number->user_id)}}</td>
                                                    <td class="text-info">{{$number->details ?? ''}}</td>
                                                    <td class="text-info">{{$number->phone ?? ''}}</td>
                                                    <td class="text-info">{{$number->price ?? ''}}</td>
                                    ...
                                    <div class="justify-content-center d-flex">
                                        {!! $numbers->appends(Request::except('page'))->render() !!}
                                    </div>
                                </div>
                            </div>
                        </div>
