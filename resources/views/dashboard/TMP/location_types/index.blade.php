<?php
$active_links = ['location_types' , 'showlocation_types'];
?>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/sidebar.location_types')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h3 class="card-title">{{__('admin/sidebar.location_types')}}</h3>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form action="{{ route('admin.location_types') }}" method="get">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3" style="padding-right: 0px !important;">
                                                    ...
                                                    <a class="btn btn-outline-primary  btn-min-width box-shadow-3"
                                                        href="{{ route('admin.location_types.create') }}">
                                                        {{__('admin/forms.add')}}
                                                    </a>
                                                </div>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($location_types as $location_type)
                                                    <tr>
                                                        <td><img src="{{$location_type->cover_path}}" class="img-thumbnail" style="width: 50px;"></td>
                                                        <td class="text-info">{{$location_type->name}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
    
                                                                <a href="{{route('admin.location_types.edit', ['id'=> $location_type -> id])}}"
                                                                   class="btn btn-info box-shadow-3 mr-1 "><i class="ft-edit"></i></a>
    
                                                                <a href="{{route('admin.location_types.delete', ['id'=> $location_type -> id])}}"
                                        ...
                                        <div class="justify-content-center d-flex">
                                            {!! $location_types->appends(Request::except('page'))->render() !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
