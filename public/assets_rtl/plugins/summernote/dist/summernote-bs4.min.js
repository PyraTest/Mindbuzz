...
!(function (t, e) {
        ...
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified &&
                    (H = require.specified("codemirror"));
    var D =
    ...
    function K(t) {
        return (
            !O(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
        );
    }
    var V = U("PRE"),
        W = U("LI");
    ...
    function wt(t, e) {
        ...
        return (
            ut(s, ct(r)),
            o || (st(t.node), st(s)),
            i && (rt(t.node) && Tt(t.node), rt(s))
                ? (Tt(s), t.node.nextSibling)
                : s
        );
    }
    function xt(t, o, n) {
    ...
    var Nt = {
        ...
        splitPoint: function (t, e) {
            ...
            var a =
                o &&
                xt(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
    ...
    function At(t) {
        var s = function (t, e) {
                ...
                if (Nt.isText(t)) {
                    ...
                    if (((o = t.childNodes[e] || t), Nt.isText(o)))
                        return s(o, 0);
                    (e = 0), (n = !1);
                }
    ...
    var Rt = (function () {
            ...
            return (
                (r.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            "EndToEnd",
                            At({ node: this.ec, offset: this.eo })
                        ),
                        e
                    );
                }),
                ...
                (r.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    if (
                        (n = n.concat(
                            Nt.listNext(t.nextSibling, Nt.isParaInline)
                        )).length
                    ) {
        ...
        Ft = {
            ...
            createFromNode: function (t) {
                ...
                return (
                    Nt.isVoid(e) &&
                        ((o = Nt.listPrev(e).length - 1), (e = e.parentNode)),
                    Nt.isBR(n)
                        ? ((i = Nt.listPrev(n).length - 1), (n = n.parentNode))
                        : Nt.isVoid(n) &&
                          ((i = Nt.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
        ...
        Dt = (function () {
            ...
            return (
                ...
                (t.prototype.stylePara = function (t, o) {
                    k.each(
                        t.nodes(Nt.isPara, { includeAncestor: !0 }),
                        function (t, e) {
                            k(e).css(o);
                        }
                    );
                ...
                (t.prototype.styleNodes = function (t, e) {
                    ...
                    var r = Nt.makePredByNodeName(o),
                        s = t
                            .nodes(Nt.isText, { fullyContains: !0 })
                            .map(function (t) {
                                return (
                                    Nt.singleChildAncestor(t, r) ||
                                    Nt.wrap(t, o)
                                );
                            });
                    if (n) {
                ...
                (t.prototype.current = function (t) {
                    ...
                    return (
                        (o.anchor =
                            t.isOnAnchor() && Nt.ancestor(t.sc, Nt.isAnchor)),
            ...
            return (
                ...
                (t.prototype.wrapList = function (t, e) {
                    ...
                    return (
                        ...
                        r &&
                            (Nt.appendChildNodes(s, N.from(r.childNodes)),
                            Nt.remove(r)),
                        t
                    );
                }),
                ...
                (t.prototype.insertParagraph = function (t, e) {
                    ...
                    if (n) {
                        ...
                        if (
                            ...
                            (s = s.concat(
                                Nt.listDescendant(o, Nt.isEmptyAnchor)
                            )),
                                k.each(s, function (t, e) {
                                    Nt.remove(e);
                                }),
            ...
            function t(t) {
                ...
                (this.insertParagraph = this.wrapCommand(function () {
                    ...
                    (this.insertHorizontalRule = this.wrapCommand(function () {
                        ...
                        t.nextSibling &&
                            Ft.create(t.nextSibling, 0).normalize().select();
                    })),
                    ...
                    (this.createLink = this.wrapCommand(function (t) {
                        ...
                        if (!(0 < r && u.isLimited(r))) {
                            ...
                            var c = Ft.createFromNodeBefore(
                                    N.head(a)
                                ).getStartPoint(),
                                d = Ft.createFromNodeAfter(
                                    N.last(a)
                                ).getEndPoint();
                            Ft.create(
                                c.node,
            ...
            return (
                (t.prototype.initialize = function () {
                    ...
                    this.$editable
                        ...
                        this.$editable.html(
                            Nt.html(this.$note) || Nt.emptyPara
                        ),
                        this.$editable.on(
                            z.inputEventName,
                            C.debounce(function () {
                    ...
                    return (
                        ...
                        (void 0 === e ||
                            !(
                                ...
                                e.metaKey ||
                                N.contains(
                                    [Lt.code.BACKSPACE, Lt.code.DELETE],
                                    e.keyCode
                                )
                            )) &&
            ...
            return (
                ...
                (t.prototype.pasteByEvent = function (t) {
                    ...
                    if (e && e.items && e.items.length) {
                        var o =
                            1 < e.items.length ? e.items[1] : N.head(e.items);
                        "file" === o.kind &&
            ...
            return (
                ...
                (t.prototype.activate = function () {
                    ...
                    if (
                        ...
                        var o = Ot.fromTextArea(
                            this.$codable[0],
                            this.options.codemirror
                        );
                        if (this.options.codemirror.tern) {
                            var n = new Ot.TernServer(
        ...
        le = (function () {
            ...
            return (
                (t.prototype.shouldInitialize = function () {
                    return (
                        this.options.airMode &&
                        !N.isEmpty(this.options.popover.air)
                    );
                }),
                (t.prototype.initialize = function () {
                    this.$popover = this.ui
        ...
        ce = (function () {
            ...
            return (
                ...
                (t.prototype.handleKeyup = function (t) {
                    ...
                    if (
                        !N.contains(
                            [Lt.code.ENTER, Lt.code.UP, Lt.code.DOWN],
                            t.keyCode
                        )
                    ) {
                        var e = this.context
    ...
    k.fn.extend({
        summernote: function () {
            ...
            (i.langInfo = k.extend(
                ...
                (i.tooltip =
                    "auto" === i.tooltip ? !z.isSupportTouch : i.tooltip),
