...
!(function (t, e) {
        ...
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified &&
                    (F = require.specified("codemirror"));
    var R =
    ...
    var j = {
        ...
        K = {
            isEdit: function (t) {
                return j.contains(
                    [q.BACKSPACE, q.TAB, q.ENTER, q.SPACE, q.DELETE],
                    t
                );
            },
            isMove: function (t) {
    ...
    function Z(t) {
        return (
            !W(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
        );
    }
    var Q = _("PRE"),
        X = _("LI");
    ...
    function Nt(t, e) {
        ...
        return (
            vt(s, mt(r)),
            o || (ht(t.node), ht(s)),
            i && (ut(t.node) && Ft(t.node), ut(s))
                ? (Ft(s), t.node.nextSibling)
                : s
        );
    }
    function Et(t, o, n) {
    ...
    var Lt = {
        ...
        splitPoint: function (t, e) {
            ...
            var a =
                o &&
                Et(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
            return (
    ...
    function Dt(t) {
        var s = function (t, e) {
                ...
                if (Lt.isText(t)) {
                    ...
                    if (((o = t.childNodes[e] || t), Lt.isText(o)))
                        return s(o, 0);
                    (e = 0), (n = !1);
                }
            ...
            return (
                (r.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            "EndToEnd",
                            Dt({ node: this.ec, offset: this.eo })
                        ),
                        e
                    );
                }),
                ...
                (r.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    var t,
                        e = this.normalize();
                    if (Lt.isParaInline(this.sc) || Lt.isPara(this.sc))
                        return e;
                    if (Lt.isInline(e.sc)) {
                    ...
                    if (
                        (n = n.concat(
                            Lt.listNext(t.nextSibling, Lt.isParaInline)
                        )).length
                    ) {
                ...
                (r.prototype.bookmark = function (t) {
                    return {
                        s: {
                            path: Lt.makeOffsetPath(t, this.sc),
                            offset: this.so,
                        },
                        e: {
                            path: Lt.makeOffsetPath(t, this.ec),
                            offset: this.eo,
                        },
                    };
                }),
        ...
        zt = {
            create: function (t, e, o, n) {
                ...
                if (2 === arguments.length)
                    return new Bt((o = t), (n = e), o, n);
                var i = this.createFromSelection();
                return i || 1 !== arguments.length
                    ? i
                    : (i = this.createFromNode(t)).collapse(
                          Lt.emptyPara === t.innerHTML
                      );
            },
            ...
            createFromNode: function (t) {
                ...
                return (
                    Lt.isVoid(e) &&
                        ((o = Lt.listPrev(e).length - 1), (e = e.parentNode)),
                    Lt.isBR(n)
                        ? ((i = Lt.listPrev(n).length - 1), (n = n.parentNode))
                        : Lt.isVoid(n) &&
                          ((i = Lt.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
        ...
        Ot = (function () {
            ...
            return (
                ...
                (t.prototype.stylePara = function (t, o) {
                    k.each(
                        t.nodes(Lt.isPara, { includeAncestor: !0 }),
                        function (t, e) {
                            k(e).css(o);
                        }
                    );
                ...
                (t.prototype.styleNodes = function (t, e) {
                    ...
                    var r = Lt.makePredByNodeName(o),
                        s = t
                            .nodes(Lt.isText, { fullyContains: !0 })
                            .map(function (t) {
                                return (
                                    Lt.singleChildAncestor(t, r) ||
                                    Lt.wrap(t, o)
                                );
                            });
                    if (n) {
                        ...
                        return s.map(function (t) {
                            ...
                            return (
                                k.each(n, function (t, e) {
                                    Lt.appendChildNodes(o, e.childNodes),
                                        Lt.remove(e);
                                }),
                                j.head(e)
                            );
                ...
                (t.prototype.current = function (t) {
                    ...
                    return (
                        (o.anchor =
                            t.isOnAnchor() && Lt.ancestor(t.sc, Lt.isAnchor)),
            ...
            return (
                ...
                (t.prototype.wrapList = function (t, e) {
                    ...
                    return (
                        ...
                        r &&
                            (Lt.appendChildNodes(s, j.from(r.childNodes)),
                            Lt.remove(r)),
                        t
                    );
                }),
                ...
                (t.prototype.insertParagraph = function (t, e) {
                    ...
                    if (n) {
                        ...
                        if (
                            ...
                            (s = s.concat(
                                Lt.listDescendant(o, Lt.isEmptyAnchor)
                            )),
                                k.each(s, function (t, e) {
                                    Lt.remove(e);
                                }),
            ...
            function k(t) {
                switch (h) {
                    case qt.where.Column:
                        if (t.isColSpan)
                            return qt.resultAction.SubtractSpanCount;
                        break;
                    case qt.where.Row:
        ...
        Vt = (function () {
            ...
            return (
                ...
                (t.prototype.addRow = function (t, e) {
                    ...
                    if ("top" === e) n.before(r);
                        ...
                        if (1 < o.rowSpan) {
                            ...
                            return void k(k(n).parent().find("tr")[h]).after(
                                k(r)
                            );
                        }
                        n.after(r);
                ...
                (t.prototype.createTable = function (t, e, o) {
                    ...
                    return (
                        o && o.tableClassName && c.addClass(o.tableClassName),
                        c[0]
                    );
                }),
            ...
            function t(t) {
                ...
                (this.insertParagraph = this.wrapCommand(function () {
                    ...
                    (this.insertHorizontalRule = this.wrapCommand(function () {
                        ...
                        t.nextSibling &&
                            zt.create(t.nextSibling, 0).normalize().select();
                    })),
                    ...
                    (this.createLink = this.wrapCommand(function (t) {
                        ...
                        if (!(0 < r && u.isLimited(r))) {
                            ...
                            k.each(a, function (t, e) {
                                k(e).attr("href", o),
                                    n
                                        ? k(e).attr("target", "_blank")
                                        : k(e).removeAttr("target");
                            });
                            var c = zt
                                    .createFromNodeBefore(j.head(a))
                                    .getStartPoint(),
                                d = zt
                                    .createFromNodeAfter(j.last(a))
                                    .getEndPoint();
                            zt.create(
                                c.node,
                                c.offset,
                    ...
                    (this.insertTable = this.wrapCommand(function (t) {
                        ...
                        u.createRange()
                            .deleteContents()
                            .insertNode(
                                u.table.createTable(e[0], e[1], u.options)
                            );
                    })),
            ...
            return (
                (t.prototype.initialize = function () {
                    ...
                    this.$editable
                        ...
                        this.$editable.html(
                            Lt.html(this.$note) || Lt.emptyPara
                        ),
                        this.$editable.on(
                            L.inputEventName,
                            D.debounce(function () {
                    ...
                    return (
                        ...
                        (void 0 === e ||
                            !(
                                ...
                                e.metaKey ||
                                j.contains(
                                    [K.code.BACKSPACE, K.code.DELETE],
                                    e.keyCode
                                )
                            )) &&
                ...
                (t.prototype.getLinkInfo = function () {
                    ...
                    return (
                        e.length &&
                            (o.isNewWindow = "_blank" === e.attr("target")),
                        o
                    );
                }),
            ...
            return (
                ...
                (t.prototype.pasteByEvent = function (t) {
                    ...
                    if (e && e.items && e.items.length) {
                        var o =
                            1 < e.items.length ? e.items[1] : j.head(e.items);
                        "file" === o.kind &&
    ...
    var Yt = (function () {
            ...
            return (
                ...
                (t.prototype.activate = function () {
                    ...
                    if (
                        ...
                        var o = Kt.fromTextArea(
                            this.$codable[0],
                            this.options.codemirror
                        );
                        if (this.options.codemirror.tern) {
                            var n = new Kt.TernServer(
                ...
                (t.prototype.update = function (t) {
                    ...
                    if ((this.context.invoke("imagePopover.update", t), e)) {
                        var n = k(t),
                            ...
                            r = {
                                left:
                                    i.left + parseInt(n.css("marginLeft"), 10),
        ...
        te = (function () {
            ...
            return (
                ...
                (t.prototype.handleKeyup = function (t) {
                    j.contains([K.code.ENTER, K.code.SPACE], t.keyCode) &&
                        this.replace();
                }),
                t
            );
        ...
        ne = (function () {
            ...
            return (
                                ...
                                n.ui.dropdown({
                                    ...
                                    template: function (t) {
                                        "string" == typeof t &&
                                            (t = {
                                                tag: t,
                                                title: n.lang.style.hasOwnProperty(
                                                    t
                                                )
                                                    ? n.lang.style[t]
                                                    : t,
                        ...
                        this.context.memo("button.underline", function () {
                            return n
                                .button({
                                    ...
                                    contents: n.ui.icon(
                                        n.options.icons.underline
                                    ),
                                    tooltip:
                                        n.lang.font.underline +
                                        n.representShortcut("underline"),
                                    click: n.context.createInvokeHandlerAndUpdateState(
                                        "editor.underline"
                                    ),
                                })
                        ...
                        this.context.memo("button.clear", function () {
                            return n
                                .button({
                                    ...
                                    tooltip:
                                        n.lang.font.clear +
                                        n.representShortcut("removeFormat"),
                                    click: n.context.createInvokeHandler(
                                        "editor.removeFormat"
                                    ),
                                })
                                    ...
                                    ],
                                    {
                                        callback: function (t) {
                                            t.find(
                                                ...
                                                .mousedown(
                                                    n.context.createInvokeHandler(
                                                        "editor.insertTable"
                                                    )
                                                )
                                                .on(
                                                    "mousemove",
                                                    n.tableMoveHandler.bind(n)
                                                );
                                        },
                                    }
                                )
                        ...
                        this.context.memo("button.link", function () {
                            return n
                                .button({
                                    ...
                                    tooltip:
                                        n.lang.link.link +
                                        n.representShortcut("linkDialog.show"),
                                    click: n.context.createInvokeHandler(
                                        "linkDialog.show"
                                    ),
                                })
                ...
                (t.prototype.build = function (t, e) {
                    for (var o = 0, n = e.length; o < n; o++) {
                        for (
                            ...
                            d &&
                                a.append(
                                    "function" == typeof d ? d(this.context) : d
                                );
                        }
                        a.appendTo(t);
                    }
                ...
                (t.prototype.updateCurrentStyle = function (t) {
                    ...
                    if (o["line-height"]) {
                        var a = o["line-height"];
                        e.find(".dropdown-line-height li a").each(function (
                            t,
                            e
                        ) {
            ...
            return (
                (t.prototype.initialize = function () {
                    var t = this.options.dialogsInBody
                        ...
                        o =
                            '<input type="button" href="/site/#" class="btn btn-primary note-btn note-btn-primary note-link-btn" value="' +
            ...
            return (
                (t.prototype.initialize = function () {
                    ...
                    var i = [
                        ...
                        r =
                            '<input type="button" href="/site/#" class="btn btn-primary note-btn note-btn-primary note-image-btn" value="' +
            ...
            return (
                (t.prototype.initialize = function () {
                    var t = this.options.dialogsInBody
                        ...
                        o =
                            '<input type="button" href="/site/#" class="btn btn-primary note-btn note-btn-primary note-video-btn" value="' +
                ...
                (t.prototype.createVideoNode = function (t) {
                    ...
                    if (o && 11 === o[1].length) {
                        ...
                        if (void 0 !== o[2]) {
                            ...
                            if (m)
                                for (
                                    var g = [3600, 60, 1], v = 0, b = g.length;
                                    v < b;
                                    v++
                                )
                                    f +=
                                        void 0 !== m[v + 1]
                                            ? g[v] * parseInt(m[v + 1], 10)
                                            : 0;
                        }
                        e = k("<iframe>")
                            .attr("frameborder", 0)
                        ...
                        e = k("<iframe>")
                            ...
                            .attr(
                                "src",
                                "https://instagram.com/p/" + n[1] + "/embed/"
                            )
                            .attr("width", "612")
                            .attr("height", "710")
                            .attr("scrolling", "no")
        ...
        he = (function () {
            ...
            return (
                (t.prototype.shouldInitialize = function () {
                    return (
                        this.options.airMode &&
                        !j.isEmpty(this.options.popover.air)
                    );
                }),
                (t.prototype.initialize = function () {
                    this.$popover = this.ui
        ...
        pe = (function () {
            function t(t) {
                ...
                (this.context = t),
                    ...
                    (this.hints = k.isArray(this.hint)
                        ? this.hint
                        : [this.hint]),
                    (this.events = {
                        "summernote.keyup": function (t, e) {
            ...
            return (
                ...
                (t.prototype.moveUp = function () {
                    ...
                    if (e.length) this.selectItem(e);
                        ...
                        var o = t.parent().prev();
                        o.length ||
                            (o = this.$content.find(".note-hint-group").last()),
        ...
        fe = (function () {
            ...
            return (
                ...
                (t.prototype.createInvokeHandlerAndUpdateState = function (
                    e,
                    o
                ) {
                    var n = this;
                ...
                (t.prototype.createInvokeHandler = function (o, n) {
                    ...
                    return function (t) {
                        ...
                        i.invoke(
                            o,
                            n || e.closest("[data-value]").data("value"),
                            e
                        );
                    };
                }),
        ...
        summernote: function () {
            ...
            (i.langInfo = k.extend(
                ...
                (i.icons = k.extend(
                    !0,
                    {},
                    k.summernote.options.icons,
                    i.icons
                )),
                (i.tooltip =
                    "auto" === i.tooltip ? !L.isSupportTouch : i.tooltip),
                this.each(function (t, e) {
                    ...
                    if (!o.data("summernote")) {
                        ...
                        o.data("summernote", n),
                            o
                                .data("summernote")
                                .triggerEvent("init", n.layoutInfo);
                    }
                });
            var n = this.first();
            if (n.length) {
