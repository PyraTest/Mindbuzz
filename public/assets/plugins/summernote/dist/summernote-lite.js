...
(function (global, factory) {
            ...
            var markup = $.isArray(options.items)
                ? options.items.map(function (item) {
                      ...
                      var content = options.template
                          ...
                          : item;
                      var $temp = $(
                          '<a class="note-dropdown-item" href="/site/#" data-value="' +
                              value +
            ...
            children: [
                ...
                dropdown({
                    ...
                    click: function (event) {
                        ...
                        var foreinput =
                            document.getElementById("html5fcp").value;
                        var backinput =
                            document.getElementById("html5bcp").value;
                        if (value === "cp") {
    ...
    var videoDialog = function (opt) {
        var body =
            ...
            "</div>";
        var footer = [
            '<button type="button" href="/site/#" class="note-btn note-btn-primary note-video-btn disabled" disabled>',
    ...
    var imageDialog = function (opt) {
        var body =
            ...
            "</div>";
        var footer = [
            '<button href="/site/#" type="button" class="note-btn note-btn-primary note-btn-large note-image-btn disabled" disabled>',
    ...
    var linkDialog = function (opt) {
        var body =
            ...
            (!opt.disableLinkTarget
                ...
                : "");
        var footer = [
            '<button href="/site/#" type="button" class="note-btn note-btn-primary note-link-btn disabled" disabled>',
    ...
    var HelpDialog = /** @class */ (function () {
        ...
        HelpDialog.prototype.initialize = function () {
            ...
            var body = [
                '<p class="text-center">',
                '<a href="/site/http://summernote.org/" target="_blank">Summernote 0.8.11</a> · ',
                '<a href="/site/https://github.com/summernote/summernote" target="_blank">Project</a> · ',
                '<a href="/site/https://github.com/summernote/summernote/issues" target="_blank">Issues</a>',
                "</p>",
            ].join("");
            this.$dialog = this.ui
                .dialog({
